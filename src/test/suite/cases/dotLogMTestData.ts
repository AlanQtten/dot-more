export default [
  ...
  ['const a = 1;  typeof a.b.c', ['console.log(`typeof a.b.c`, typeof a.b.c)', 14]],
  ['const a = 1;   typeof a.b.c', ['console.log(`typeof a.b.c`, typeof a.b.c)', 15]],
  ['const a = 1;    typeof a.b.c', ['console.log(`typeof a.b.c`, typeof a.b.c)', 16]],
  // test for "typeof" with bracket
  ['typeof str.slice(a.b.c)', ['console.log(`typeof str.slice(a.b.c)`, typeof str.slice(a.b.c))', 0]],
  // test for "typeof" with bracket and with space before
  ['  typeof str.slice(a.b.c)', ['console.log(`typeof str.slice(a.b.c)`, typeof str.slice(a.b.c))', 2]],
  ['   typeof str.slice(a.b.c, 1, 50)', ['console.log(`typeof str.slice(a.b.c, 1, 50)`, typeof str.slice(a.b.c, 1, 50))', 3]],
  ['    typeof str.slice(String(a.b.c), 1, 50)', ['console.log(`typeof str.slice(String(a.b.c), 1, 50)`, typeof str.slice(String(a.b.c), 1, 50))', 4]],
  ['     typeof arr.filter(item => item !== -1 && Boolean(item))', ['console.log(`typeof arr.filter(item => item !== -1 && Boolean(item))`, typeof arr.filter(item => item !== -1 && Boolean(item)))', 5]],
  // test for "typeof" with bracket and with some other code before
  ['const a = 1; typeof str.slice(a.b.c)', ['console.log(`typeof str.slice(a.b.c)`, typeof str.slice(a.b.c))', 13]],
  ['const a = 1;  typeof str.slice(a.b.c, 1, 50)', ['console.log(`typeof str.slice(a.b.c, 1, 50)`, typeof str.slice(a.b.c, 1, 50))', 14]],
  ['const a = 1;   typeof str.slice(String(a.b.c), 1, 50)', ['console.log(`typeof str.slice(String(a.b.c), 1, 50)`, typeof str.slice(String(a.b.c), 1, 50))', 15]],
  [
    'const a = 1;    typeof arr.filter(item => item !== -1 && Boolean(item))', 
    ['console.log(`typeof arr.filter(item => item !== -1 && Boolean(item))`, typeof arr.filter(item => item !== -1 && Boolean(item)))', 16]
  ],
  // more complex situation
  [`a + b === c / d && (e - f)`, [`console.log(\`a + b === c / d && (e - f)\`, a + b === c / d && (e - f))`, 0]],
  [`  a + b === c / d && (e - f)`, [`console.log(\`a + b === c / d && (e - f)\`, a + b === c / d && (e - f))`, 2]],
  [`typeof a + b === c / d && (e - f) === 'function'`, [`console.log(\`typeof a + b === c / d && (e - f) === 'function'\`, typeof a + b === c / d && (e - f) === 'function')`, 0]],
  [`  typeof a + b === c / d && (e - f) === 'function'`, [`console.log(\`typeof a + b === c / d && (e - f) === 'function'\`, typeof a + b === c / d && (e - f) === 'function')`, 2]],
  [`const a = 1;  typeof a + b === c / d && (e - f) === 'function'`, [`console.log(\`typeof a + b === c / d && (e - f) === 'function'\`, typeof a + b === c / d && (e - f) === 'function')`, 14]],
